...
glparam_name='ext_iqc_dzn_e';
pos=checkblockpos(block_path,glparam_name);
alparam_name={'name','pole','def_num_h','slo_bou','outvariable','path','newpath'};
alparam={block_name,pole,def_num_h,slo_bou,str,block_path,block_newpath};
...
ext_iqc_setvalues.ext_iqc_dzn_e.sampletime{pos}(1:2)=di(1);
...
ext_iqc_setvalues.ext_iqc_dzn_e.size{pos}(1:2)=di;
...
if ~isfield(ext_iqc_setvalues.ext_iqc_dzn_e,'size')
    ext_iqc_setvalues.ext_iqc_dzn_e.size{pos}(1:2)=...
