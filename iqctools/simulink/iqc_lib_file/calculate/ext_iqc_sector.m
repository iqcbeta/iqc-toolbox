...
str=['plot(0,0,100,100,[100,-0],[54,54],[50,50],[0,100],[66,32],',...
    '[100,0],[-0,100],[37,71],[20,-0],[0,32],[33,13],[5,41],[40,28],',...
    '[24,46],[47,42],[44,51],[65,57],[60,73],[78,63],[64,90],[95,77],',...
    '[69,100],[91,85,82,78,77,75,74,66,61,56,54,50,48,45,43,42,40,38,',...
    '35,31,27,24,21,17,14,11,10,8,7],[96,96,93,90,82,76,71,66,66,63,',...
    '60,54,51,49,46,42,38,34,32,32,32,32,32,31,29,27,24,18,13]);'];
...
ext_iqc_setvalues.ext_iqc_sector.sampletime{pos}(1:2)=di(1);
...
ext_iqc_setvalues.ext_iqc_sector.size{pos}(1:2)=di;
...
if ~isfield(ext_iqc_setvalues.ext_iqc_sector,'size')
    ext_iqc_setvalues.ext_iqc_sector.size{pos}(1:2)=...
