...
%
%   VPERP = PERP(V) is the orthogonal complement of V, i.e., matrices
%   with a maximal number of column vectors forming an orthonormal
%   set such that V'*VPERP=0 (all column vectors of vperp are
%   perpendicular to all column vetors of v).
%
