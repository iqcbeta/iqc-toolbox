function [Q]=rfs_c(G,d,nu);
%RFS_C  Global asymptotic stability of limit cycles of relay feedback
%   systems. Same as hys_globsta but stability analysis is done with the
%   conic relations resulting in a less conservative condition.
%
%   RFS_C(SYS,D,NU)  proves global asymptotic stability of the
%   limit cycle of the system SYS in hysteresis relay feedback.  It
