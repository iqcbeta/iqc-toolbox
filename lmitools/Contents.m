% IQC Toolbox     : Functions related to LMI applications
%
% abst_init_fdlmi : initializes the abstract environment for handling 
%                   Frequency Dependent LMI models (FD-LMI)
